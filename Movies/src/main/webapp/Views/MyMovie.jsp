...
<body style="background-color: rgb(0, 0, 0);">
	<div style="position: relative;z-index: 100;">
	  ...
	  <div class="container">
        <div style="color: rgb(255, 255, 255); font-size: 35px;">PHIM CỦA TÔI</div>
        <hr style="width: 100px; color: #ffcd07; opacity: 1;">
			<c:if test="${empty mymovie}">
				<h1 class="text-center">BẠN KHÔNG CÓ PHIM NÀO</h1>
			</c:if>        
        <div class="row">
        <!--  vong lap o day --> 
				...
				<div class="col-6 col-sm-6 sp col-lg-2 col-md-4 mt-3"
					...
					<div class="card text-start" style="background-color: black;">
						...
						<div class="middle">
										...
										<br>
										<a href="movieremove?namemovieremove=${mymovie.title}" class="btn btn-danger text-white mt-3">
											<i class="fa-solid fa-bookmark"></i> Xóa
										</a>
						</div>
					</div>
